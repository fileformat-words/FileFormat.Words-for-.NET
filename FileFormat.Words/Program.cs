        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (Document doc = new Document())
                {
                    ...
                    TableProperties tblProp = new TableProperties(20, table.borderValue_BasicBlackSquares);

                    // set the position of the table to Right.
                    tblProp.Append(new TableJustification(table.AlignRight));
                    ...
                    imageRun.AppendChild(image.Drawing);
                ...
                using (Document doc1 = new Document(rootDir + "/Docs2.docx"))
                {
                    ...
                    List<ImagePart> imageParts = Image.ExtractImagesFromDocument(doc1);
                    ...
                    {
                        // You can access the image data from the imagePart
                        // For example, you can save the image to a file using the following code:
